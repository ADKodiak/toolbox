...
<?php // Condition a mettre ici pour vérifier si il ya des boites
  $id_cet = $_SESSION['id'];
            ...
            $reponse = $bdd->query("SELECT * FROM boite JOIN posseder ON posseder.id_boite=boite.id_boite JOIN utilisateur ON posseder.id_utilisateur=utilisateur.id_utilisateur WHERE utilisateur.id_utilisateur=$id_cet" ); 
 while ($donnees = $reponse->fetch()) {

 if($_SESSION['langue'] =='fr' || $_SESSION['langue'] == NULL)  {

?>
<div class="col-sm-12 boiteDesign" onclick="enregistrerClickBoite(this)" id="<?php echo $donnees['id_boite']; ?>">
  <center><h1 id="boite" style="font-family: 'Oswald', sans-serif;display: inline;"> Boite </h1><h1 style="font-family: 'Oswald', sans-serif;display: inline;"> <?php echo $donnees['boite.nom']; ?></h1></center>
</div>
...
?>
<div class="col-sm-12 boiteDesign" onclick="enregistrerClickBoite(this)" id="<?php echo $donnees['id_boite']; ?>">
  <center><h1 id="boite" style="font-family: 'Oswald', sans-serif;display: inline;"> Box</h1><h1 style="font-family: 'Oswald', sans-serif;display: inline;"> <?php echo $donnees['boite.nom']; ?></h1></center>
</div>
<?php
}
?>
